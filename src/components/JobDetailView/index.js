...
//           <img src={} alt={} className="skill-img-size" />
...
//         <img src={} alt=" life at company" className="life-at-company-img" />
//       </div>
//     </div>
//     <h1>Similar Jobs</h1>
...
//           <h1 className="similar-company-title-para">{title}</h1>
...
//             <p className="similar-employment-para">{employmentType}</p>
//           </div>
//         </div>
//       </div>
//     </div>
